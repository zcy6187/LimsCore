...
{
    public partial class mir1215 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Man_Banci = table.Column<string>(nullable: true),
                    Man_Luci = table.Column<string>(nullable: true),
                    Man_Pinci = table.Column<string>(nullable: true),
                    SamplingDate = table.Column<DateTime>(nullable: false),
                    SamplingTime = table.Column<string>(maxLength: 5, nullable: true),
                    TplId = table.Column<int>(nullable: false),
                    SpecId = table.Column<string>(nullable: true),
                    ElementIds = table.Column<string>(nullable: true),
                    SelfCode = table.Column<string>(nullable: true),
                    Lx = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_assay_Attendance", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_assay_Element", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_assay_Specimen", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrgCode = table.Column<string>(nullable: true),
                    OrgName = table.Column<string>(nullable: true),
                    TplName = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_assay_Template", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CmdToken = table.Column<string>(nullable: true),
                    OrgCode = table.Column<string>(nullable: true),
                    OrgName = table.Column<string>(nullable: true),
                    TplIds = table.Column<string>(nullable: true),
                    IsDeleted = table.Column<bool>(nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_assay_Token", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "assay_TplElement",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    TplId = table.Column<int>(nullable: false),
                    TplSpecId = table.Column<int>(nullable: false),
                    TplName = table.Column<string>(nullable: true),
                    ...
                    MaxNum = table.Column<float>(nullable: false),
                    MinNum = table.Column<float>(nullable: false),
                    IsUse = table.Column<bool>(nullable: false),
                    RowNum = table.Column<string>(nullable: true),
                    CreateTime = table.Column<DateTime>(nullable: false),
                    LastModifyTime = table.Column<DateTime>(nullable: false),
                    CreatorId = table.Column<int>(nullable: false),
                    Creator = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_assay_TplElement", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "assay_TplSpecimen",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_assay_TplSpecimen", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SamplingTime = table.Column<string>(nullable: true),
                    SamplingDate = table.Column<DateTime>(nullable: false),
                    Lx = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_assay_TypeIn", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "assay_TypeInItem",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    TypeInId = table.Column<int>(nullable: false),
                    TplId = table.Column<int>(nullable: false),
                    SpecimenId = table.Column<int>(nullable: false),
                    ElementId = table.Column<int>(nullable: false),
                    UnitName = table.Column<string>(nullable: true),
                    EleValue = table.Column<string>(nullable: true),
                    IsDeleted = table.Column<bool>(nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_assay_TypeInItem", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_assay_Unit", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sys_OrgInfo", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<long>(nullable: false),
                    TplIds = table.Column<string>(nullable: true),
                    Lx = table.Column<int>(nullable: true),
                    IsDeleted = table.Column<bool>(nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_sys_UserTpl", x => x.Id);
                });
